 ...
 * 
 * Handles worker startup and shutdown procedures:
 * - Auto scraper scheduled jobs initialization
 * - Event-driven job status synchronization
 * - Cleanup of old/stale jobs
 * 
 * Used by: lib/workers/worker.ts (main unified worker)
 */
