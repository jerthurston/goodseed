/**
 * 🎯 TRUE NORTH SEED BANK PRODUCT DETAIL EXTRACTOR
 *
 * Extracts product data from True North Seed Bank product detail pages
 * Based on True North Seed Bank specific structure with data-th attributes and Fotorama galleries
 */
