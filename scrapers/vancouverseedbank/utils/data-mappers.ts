/**
 * Helper functions to map scraped data to Prisma enums
 */
 ...
 * Examples:
 * - "Alien Candy Strain Autoflowering Feminized Marijuana Seeds" -> AUTOFLOWER
 * - "10th Planet Strain Feminized Marijuana Seeds" -> FEMINIZED
 * - "Alien OG Strain Regular BCBD Marijuana Seeds" -> REGULAR
 */
export function parseSeedType(productName: string): SeedType | null {
    ...
    if (nameLower.includes('autoflower')) {
...
export function testParsers() {
    console.log('Testing parseSeedType:');
    console.log('  Autoflowering Feminized:', parseSeedType('Alien Candy Strain Autoflowering Feminized Marijuana Seeds'));
    console.log('  Feminized:', parseSeedType('10th Planet Strain Feminized Marijuana Seeds'));
    console.log('  Regular:', parseSeedType('Alien OG Strain Regular BCBD Marijuana Seeds'));
